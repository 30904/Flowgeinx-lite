...
export default function VaultSidebar({ category, onCategoryChange }) {
  ...
  return (
    <aside className="flex w-full shrink-0 flex-col bg-navy md:w-60 lg:w-64">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4">
        <p className="section-label mb-2 px-3">Vault</p>
